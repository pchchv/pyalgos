...
WIKI REFERENCES :
    ...
    https://en.wikipedia.org/wiki/Kilometer
    https://en.wikipedia.org/wiki/Feet
    https://en.wikipedia.org/wiki/Inch
    https://en.wikipedia.org/wiki/Centimeter
...
def length_conversion(value: float, from_type: str, to_type: str) -> float:
    ...
    return value * METRIC_CONVERSION[new_from].from_ * \
        METRIC_CONVERSION[new_to].to
