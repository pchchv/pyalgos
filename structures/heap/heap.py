...
class Heap:
    ...
    def left_child_idx(self, parent_idx: int) -> int | None:
        """Returns the left child index if the left child exists.
        If not, return None.
        """
    ...
    def right_child_idx(self, parent_idx: int) -> int | None:
        """Returns the right child index if the right child exists.
        If not, return None.
        """
    ...
    def max_heapify(self, index: int) -> None:
        ...
        if index < self.heap_size:
            ...
            if left_child is not None:
                if self.h[left_child] > self.h[violation]:
                    violation = left_child
            if right_child is not None:
                if self.h[right_child] > self.h[violation]:
                    violation = right_child
            # if violation indeed exists
            if violation != index:
                # swap to fix the violation
                self.h[violation], self.h[index] = \
                    self.h[index], self.h[violation]
